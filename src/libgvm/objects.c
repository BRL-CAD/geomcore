...
int
gvm_object_in_model(struct gvm_info *repo_info, const char *model_name, const char *obj_name, size_t ver_num) {
    int ret = 1;
...
gvm_get_repo_obj(struct gvm_info *repo_info, const char *model_name, const char *obj_name, size_t ver_num) {
...
int
gvm_diff(struct gvm_info *repo_info, struct bu_external *obj1, struct bu_external *obj2) {
...
int
gvm_add_to_list(struct gvm_info *repo_info, struct repository_objects *obj) {
